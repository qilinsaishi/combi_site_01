...
$params = [
    "allPlayerList"=>["dataType"=>"intergratedPlayerList","page"=>($currentGame=="all")?$page:1,"page_size"=>$info['page']['page_size'],"fields"=>'pid,player_name,logo',"game"=>array_keys($config['game']),"cacheWith"=>"currentPage","cache_time"=>86400*7],
...
foreach ($config['game'] as $game => $gameName)
{
    $params[$game."PlayerList"] =
        ["dataType"=>"intergratedPlayerList","page"=>($currentGame==$game)?$page:1,"page_size"=>$info['page']['page_size'],"game"=>$game,"fields"=>'pid,player_name,logo',"cacheWith"=>"currentPage","cache_time"=>86400*7];
}
