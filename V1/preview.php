<?php
require_once "function/init.php";//parse_url(
$cdata=$_POST;
$refererUrl = parse_url($_SERVER['HTTP_REFERER']);
$host=$refererUrl["host"];
if(strpos($host,'qilindianjing.com')===false){
	 render404($config);
}
            ...
            <div class="row clearfix">
                <div class="game_left news fl">
                    <div class="news_top">
                        ...
                        <p class="news_time"><?php  echo date("Y.m.d H:i:s",strtotime($return['information']['data']['create_time']));?></p>
